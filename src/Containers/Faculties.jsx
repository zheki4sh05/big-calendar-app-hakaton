...
const fName = ["FCAD", "FITC", "TUC", "FCSN", "FRE", "FEE", "FIS", "MF"];
...
function Faculties() {
  ...
  return (
    <Box sx={{ width: "100vw" }}>
              ...
              <Grid key={index} item xs={1.5}>
                ...
                >
                  <Typography
                    ...
                    sx={{ color: "white" }}
                  >
                    <strong>{facultyName(item)}</strong>
                  </Typography>
                </Box>
              </Grid>
            ))}
      ...
      >
        <BottomNavigation
          sx={{ pl: 2, borderRadius: "10px", pb: "10px", height: "auto" }}
        >
                  ...
                  >
                    ...
                    >
                      <Typography variant="body2">
                        Корпус: {value.university_building}
                      </Typography>
                    </Box>
                    <Box
                      sx={{
                    ...
                    >
                      <Typography variant="body2">
                        Ссылки: {<br />} <a href={value.url}> {value.url}</a>
                      </Typography>
                    </Box>
                  </Box>
                </Grid>
